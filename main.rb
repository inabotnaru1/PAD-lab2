...
begin
at_exit do
  RestClient.put GATEWAY_ADRESS + "services/deregister/" + SERVICE_ID, {}.to_json
end
rescue
...
begin
RestClient.put GATEWAY_ADRESS + "register", {"ID": SERVICE_ID, "Name": "orders-service","Address": "orders-service","Port": 8000}.to_json
rescue
